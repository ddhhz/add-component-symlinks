...
var addComponentSymlinks = suspend.async(wrapGenerator.mark(function callee$0$0(dirname) {
  var stat, dirs, nodeModulesDir, i, dir;

  return wrapGenerator(function callee$0$0$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
    case 0:
      context$1$0.next = 2;
      return fs.lstat(dirname, resume());
    case 2:
    ...
    case 7:
      ...
      return context$1$0.abrupt("return");
    case 9:
      nodeModulesDir = path.resolve(dirname, 'node_modules');
      context$1$0.prev = 10;
      context$1$0.next = 13;
      return fs.readdir(nodeModulesDir, resume());
    case 13:
    ...
    case 23:
      ...
      for (i = 0; i < dirs.length; i++) {
        dir = path.resolve(nodeModulesDir, dirs[i]);
  ...
  }, callee$0$0, this, [[10, 16]]);
}));

var processDir = suspend.async(wrapGenerator.mark(function callee$0$1(dirname) {
  ...
  return wrapGenerator(function callee$0$1$(context$1$0) {
    ...
    case 7:
      ...
      return context$1$0.abrupt("return");
    case 9:
      componentPath = path.resolve(dirname, 'component.json');
      context$1$0.prev = 10;
      context$1$0.next = 13;
      return fs.readFile(componentPath, 'utf8', resume());
    case 13:
    ...
    case 21:
      ...
      return context$1$0.abrupt("return");
    case 23:
      nodeModulesDir = path.dirname(dirname);
